...
DATABASE = config.get('MYSQL_DATABASE') or 'uwork'
USERNAME = config.get('MYSQL_USERNAME') or 'uwork'
PASSWORD = config.get('MYSQL_PASSWORD') or 'uwork'
...
def init_db():
    ...
    execute_fromfile('uwork.sql')
    print('表创建成功')
    print('欢迎使用uwork,请使用 flask run 命令启动程序')
